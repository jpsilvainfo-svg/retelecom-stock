...
function RelPage({stock,os,returns,users,isMobile,currentUser}){
  ...
  const print=()=>{
    ...
    w.document.write(`<html><head><title>StockTel Relatório</title><style>body{font-family:Arial;padding:20px;color:#111;}h1{color:#c68500;}h2{border-bottom:2px solid #cc0000;padding-bottom:4px;margin:20px 0 8px;}table{width:100%;border-collapse:collapse;font-size:12px;margin-bottom:16px;}th{background:#f5f5f5;padding:7px 10px;text-align:left;border:1px solid #ddd;}td{padding:6px 10px;border:1px solid #eee;}.ok{color:green}.low{color:orange}.crit{color:red}@media print{button{display:none}}</style></head><body>
    <h1>⚡ STOCKTEL</h1><p style="color:#888;font-size:11px">Gerado em ${now()}</p>
    <button onclick="window.print()" style="margin:10px 0;padding:8px 16px;background:#cc0000;color:#000;border:none;cursor:pointer;border-radius:4px;font-weight:700">🖨️ Imprimir PDF</button>
